...
@section('content')
    ...
    <section class="content ">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <form method="post" action="{{route('product_edit',$products_edit->id)}}" id="productform" enctype="multipart/form-data">
                    @csrf
                    <!-- product  colum -->
                        <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="product_slug" name="product_slug" value="{{$products_edit->product_name}}"/>
                                </div>

                                <div class="form-group">
                                    <label for="description">{{__('Description')}}</label>
                                    <textarea class="form-control" id="editor1" name="description" rows="5" cols="100">{{$products_edit->description}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="regular_price">{{__('regular price')}}</label>
                                    <input type="text" class="form-control" id="regular_price" name="regular_price"value="{{$products_edit->regular_price}}"/>
                                    <font style="color: red">{{($errors->has('regular_price'))?($errors->first('regular_price')):''}}</font>
                                </div>
                                <div class="form-group">
                                    <label for="sale_price">{{__('sale  price')}}</label>
                                    <input type="text" class="form-control" id="sale_price" name="sale_price"value="{{$products_edit->sale_price}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="product_model" name="product_model"value="{{$products_edit->product_model}}">
                                </div>
                                <div class="form-group">
                                    <label for="product_code">{{__('Product code')}}</label>
                                    <input type="text" class="form-control" id="product_code" name="product_code"value="{{$products_edit->product_code}}">
                                </div>
                                <div class="form-group">
                                    <label for="product_status">{{__('product status')}}</label>
                                    <select class="form-control"  name="product_status" id="product_status" style="width: 30%;">
                                        <option value="1" {{($products_edit->product_status =="1")?"selected":""}}>New</option>
                                        <option value="0" {{($products_edit->product_status =="0")?"selected":""}}>None</option>
                                     </select>
                                </div>
                                <div class="form-group">
                                    <label for="product_weight">{{__('product weight')}}</label>
                                    <input type="text" class="form-control" id="product_weight" name="product_weight"value="{{$products_edit->product_weight}}">
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="color_id[]" multiple class="form-control select2">
                                            @foreach($colors as $color)
                                                <option value="{{$color->id}}" {{$color->id== $color->id
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="size_id[]" multiple class="form-control select2">
                                            @foreach($sizes as $size)
                                                <option value="{{$size->id}}" {{$size->id== $size->id
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tags_id[]" multiple class="form-control select2" >
                                        ...
                                        @foreach($tags as $tag)
                                            <option value="{{$tag->id}}" {{$tag->id== $tag->id
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($products_edit->warranty=='1')
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="warranty" id="warranty" value="1"{{($products_edit->status =="1")?"selected":""}} >
                                            {{__('Yes')}}
                                        </label>
                                    </div>
                                    ...
                                    <div class="radio">
                                        <label>
                                            ...
                                            ($products_edit->warranty =="0")?"selected":""}} >
                                            {{__('No')}}
                                        </label>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="warranty_duration" id="warranty_duration"
                                                   placeholder="warranty duration" value="{{$products_edit->warranty_duration}}"/>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      name="warranty_condition"placeholder="description" rows="5"
